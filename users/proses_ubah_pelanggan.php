...
if ($_POST) {
    ...
    if (empty($nama_pelanggan)) {
        ...
        if (empty($telp)) {
            $update = mysqli_query($conn, "UPDATE pelanggan SET nama_pelanggan='$nama_pelanggan', alamat='$alamat' WHERE id_pelanggan='$id_pelanggan'") or die(mysqli_error($conn));
            if ($update) {
            ...
            $update = mysqli_query($conn, "UPDATE pelanggan SET nama_pelanggan='$nama_pelanggan', alamat='$alamat', telp='$telp' WHERE id_pelanggan='$id_pelanggan'") or die(mysqli_error($conn));
            if ($update) {
                echo "<script>alert('Sukses update pelanggan');location.href='tampil_pelanggan.php';</script>";
            } else {
                echo "<script>alert('Gagal update pelanggan');location.href='ubah_pelanggan.php?id_pelanggan=".$id_pelanggan."';</script>";
