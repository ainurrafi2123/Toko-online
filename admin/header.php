        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= (basename($_SERVER['PHP_SELF']) == 'tambah_produk.php') ? 'active' : ''; ?>" href="tambah_produk.php"><i class="fas fa-tag"></i> Tambah Produk</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= (basename($_SERVER['PHP_SELF']) == 'tampil_petugas.php') ? 'active' : ''; ?>" href="tampil_petugas.php"><i class="fa-solid fa-user"></i> Profile</a>
                    </li>
                    <li class="nav-item">
